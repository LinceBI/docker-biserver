...
ARG TOMCAT_LIN_CHECKSUM="9a28432e7eb6b06f2f310efe5ac85b2005952d46d1b27fbb2921f87ab1d3afba"
...
ARG TOMCAT_WIN_CHECKSUM="c8b8d2733c7d822b03c4c6a4615c224d3417ed8afafab45e93e725ba41136433"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="499a47cfa01fd920a6052e1049d8bb4b2ebd78caae711a346deafe089334b5fb"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="83561cbecc0890eeeb8a90cf33aa4769f73deb5404e36703706838fee6bdb12d"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="9a71ae51d52f5d68ee4f39039585a11a89742ae000e47c3af2b2a95cb2749275"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="e9304be4e8bac5be5dd5b33ecd19569f79cad175bb0874e0ebebe015a61a0afe"
...
ARG VERTICA_JDBC_URL="https://repo1.maven.org/maven2/com/vertica/jdbc/vertica-jdbc/11.0.1-0/vertica-jdbc-11.0.1-0.jar"
ARG VERTICA_JDBC_CHECKSUM="32884f8671b8dc6f6ae1a210036dbb647ff40963a7ec7e66141e701fcd7e4836"
RUN cd "${CATALINA_BASE:?}"/lib/ \
...
ARG SPRING_SECURITY_CAS_URL="https://repo1.maven.org/maven2/org/springframework/security/spring-security-cas/4.1.5.RELEASE/spring-security-cas-4.1.5.RELEASE.jar"
ARG SPRING_SECURITY_CAS_CHECKSUM="45e6fab4f78b9c7ce8d01dd96f14c4b49b730247cfbc2819b3e451dd30ced499"
RUN cd "${CATALINA_BASE:?}"/webapps/"${WEBAPP_PENTAHO_DIRNAME:?}"/WEB-INF/lib/ \
