...
ARG TOMCAT_LIN_CHECKSUM="cb8aed230aa2f15cc5c2439b044dd88d6ec8900e46d81ee63c4d1090c0937e32"
...
ARG TOMCAT_WIN_CHECKSUM="ecac9071fdd9711d5391ee7724a090bc54ad75b2dbb3761433e7bb30ef75e72e"
...
ARG BISERVER_VERSION="9.4.0.1-465"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="3325535995ab9d895d494e0eba85a849647642348603f5d9a8641b141bd4aaa6"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="cf500eeb1fe11a60d25c77ef8352b72c380e269d8c56f944fe038896acb371d2"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="7d29e40c1c80bc22f300f2e215f4662eea2dfbf6713bef56236e9ec23b735822"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="326b534c1ca1a8dffcd83fc1a5327295e80d36d524078510a8976b3811ea8d0b"
...
ARG VERTICA_JDBC_URL="https://repo1.maven.org/maven2/com/vertica/jdbc/vertica-jdbc/24.2.0-0/vertica-jdbc-24.2.0-0.jar"
ARG VERTICA_JDBC_CHECKSUM="26bf853160d8aeeed7ca5662cb6a52428656045591bf9f95226deb8b5a4e23b9"
RUN cd "${CATALINA_BASE:?}"/lib/ \
...
ARG CLICKHOUSE_JDBC_URL="https://repo1.maven.org/maven2/com/clickhouse/clickhouse-jdbc/0.6.0-patch5/clickhouse-jdbc-0.6.0-patch5-shaded.jar"
ARG CLICKHOUSE_JDBC_CHECKSUM="aff7d655befa3b40f67b208d5b3ac02046ac656ed33cb302740aec5e0d4f2ebd"
RUN cd "${CATALINA_BASE:?}"/lib/ \
