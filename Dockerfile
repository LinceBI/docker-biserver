...
ARG BISERVER_VERSION="9.3.0.2-617"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="8dbf58023b0f52da5d833b3a4c3946183ee1742530b8adfa2efed9354fdd310f"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="9f53efcebf4bb23f5a69d5143f3e2d15d995e0fe7915ea8d7920d5da6a1a07ea"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="95d153f949124f4af7dd6dceea3b396ce57b81ef873f0603ba52cba155d5bc5b"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="c47c0c42bfe207165e3744bcc2b85dd4e03ad467c58849c3ef590f41021fc1dc"
...
# Install MSSQL JDBC
ARG MSSQL_JDBC_URL="https://repo1.maven.org/maven2/com/microsoft/sqlserver/mssql-jdbc/11.2.3.jre11/mssql-jdbc-11.2.3.jre11.jar"
ARG MSSQL_JDBC_CHECKSUM="ec9f3f9c31714952874e8b6aa837e97b11480ff224c276f43140a040c90776a1"
RUN cd "${CATALINA_BASE:?}"/lib/ \
