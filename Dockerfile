...
ARG TOMCAT_LIN_CHECKSUM="69e0f353ea7d85004f9de379c1ea68e5775287fe2e0859c56081e085c1b29226"
...
ARG TOMCAT_WIN_CHECKSUM="e4ae71e49cde9a535fc254a53953d3b9908a247cea43ca9972ab89fed6c40c6b"
RUN <<-EOF
...
ARG BISERVER_VERSION="9.3.0.9-875"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="0c2968be1c2c062e94ec745e22c6b607365ce0baeb6942556e08617a07ba187b"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="eaccbdd9b0a9a9699a3486bf81bbab3050c640d7530cb21e7ad4695ee97fdb4e"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="0abc03d3c26792789bd3fd36d3161beb9991dfbaf0f367aaa94e6500543f3c30"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="ce7a48c0abc97bfe8ad53ca5b8d88442af09b9178b404655ff8f89b29f9c4079"
RUN <<-EOF
