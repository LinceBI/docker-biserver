...
ARG BISERVER_VERSION="9.3.0.9-874"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="fd22658ee5ae3df90f06300012a0c4deccba2c89a490648d9a92004be068db18"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="cde426c72ff00e77f6697ee40c97f74927a73478528424a6f741d196ba631583"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="1f3a6d08e0a26f9cbd9ae1ffa6f387e4bbae517dd568978e0ba768dd09a46f95"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="9cbc7ae003fe57dcc1689e90a48720bad0481e4c2da81a15780c6591ed48ef41"
RUN <<-EOF
