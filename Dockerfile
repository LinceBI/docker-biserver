...
ARG BISERVER_VERSION="8.3.0.16-1030"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="ff77a43c1ea4c3d96b09d0384b72baa58a9ac12db92a1ed5109a2cd403fd8ed4"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="6aa2ee49d19630cc84e2db223443579086fb405060200dcd4383353b18869114"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="04a42e5cf9a50864256934ae934c95f3326e71d55de9aca00c701aca951e5653"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="ce29ec9fcc94aa5ebd1d76434bcf80ce916c35c18c88eb26012a5db3d89d8623"
