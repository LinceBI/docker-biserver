...
ARG BISERVER_VERSION="8.3.0.24-1374"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="5fb2a4281161857234a9abb56bd4af0452d1534dc2cc273ba9a6d008e9214c32"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="005f95294e1af4d93a4dd8151cb0e1aaeb76ea272451ba8df410784eec733a7a"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="04a562ddea8a664db772a4dcf48cde2248299e6f009166af0cb0bf8d070fb19b"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="b3ca8f748f2a0ebdb449e5ff31443a8a4f559a8107abb362a111d0aa6e297bed"
