...
ARG BISERVER_VERSION="8.3.0.21-1196"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="dd1886cbc77d765f4398447e9701cd761e0cca44d4641ddc4dd42f6fe4438643"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="f55fef633f13a3c04929e4c06374505443a8892d4bde590519fee03f7a0b39a2"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="0369ae4803061873a2f5dc6c9d929ead0a0b659c9d42d41ef0264d63eaf00c8d"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="85e12a6a474c51a18ffaa696a3eb55d9f793a374cf3f278abf9fc91379b97e18"
