...
ARG BISERVER_VERSION="8.3.0.27-1590"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="4a8c0528cd344c48ac68a7240d1994db5d6177242a3e826a54ee34c6e6f49b78"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="eb691ea37ec601b198d8fa0763a5623ad6943e1da9d8de2da903f6ae11e5f1ff"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="404512d9cd3ebcaea97db74f1866e636859143f2f675ecfd0c17e143319731e7"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="5c876d410edeac805243c99ef6a9e00661ff242830107ef2977dc511488133b0"
