...
ARG TOMCAT_LIN_CHECKSUM="38bc58342dccc3b0b2c238f55ff4f579a0a550758be940492e47e3fa622fb3a4"
...
ARG TOMCAT_WIN_CHECKSUM="3d9ce64569d9bbe0211f9567cdd148676ace14c2749b36ad270b8ae4a622937f"
...
ARG BISERVER_VERSION="8.3.0.28-1658"
...
ARG BISERVER_SOLUTIONS_CHECKSUM="d8bebf94e813f8dcce75c5ac14c3fb41b4f7ad455ba386e9727c7fa1ce14a838"
ARG BISERVER_DATA_URL="${BISERVER_BASE_URL}/pentaho/pentaho-data/${BISERVER_VERSION}/pentaho-data-${BISERVER_VERSION}.zip"
ARG BISERVER_DATA_CHECKSUM="29ccf037745dfe21cb293dd9a5895274fa9c1cc5f977bdd43904687b5de12c96"
ARG BISERVER_WAR_URL="${BISERVER_BASE_URL}/pentaho/pentaho-war/${BISERVER_VERSION}/pentaho-war-${BISERVER_VERSION}.war"
ARG BISERVER_WAR_CHECKSUM="9a906cbaa75a1b041a4d9659b05c34a08d0a1688a600f8371b75071b56de6366"
ARG BISERVER_STYLE_URL="${BISERVER_BASE_URL}/pentaho/pentaho-style/${BISERVER_VERSION}/pentaho-style-${BISERVER_VERSION}.war"
ARG BISERVER_STYLE_CHECKSUM="66a9da045785b0eb9fc12c3dd011ac742bce5236d63117dafc146bca04526e33"
...
# Install HSQLDB JDBC
ARG HSQLDB_JDBC_URL="https://repo1.maven.org/maven2/org/hsqldb/hsqldb/2.7.1/hsqldb-2.7.1-jdk8.jar"
ARG HSQLDB_JDBC_CHECKSUM="481b3b9fd77a4ce6a37ae3a3745d5d50e175faf39e8c8917404dcd1e6c7e1a17"
RUN cd "${CATALINA_BASE:?}"/lib/ \
...
# Install MSSQL JDBC
ARG MSSQL_JDBC_URL="https://repo1.maven.org/maven2/com/microsoft/sqlserver/mssql-jdbc/11.2.1.jre8/mssql-jdbc-11.2.1.jre8.jar"
ARG MSSQL_JDBC_CHECKSUM="a81bedcf2baa4e161ed883826a65a49be5a3a0ebc2543d789c684841aa5e07b4"
RUN cd "${CATALINA_BASE:?}"/lib/ \
