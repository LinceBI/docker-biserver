...
> * **`MAIL_TRANSPORT_PROTOCOL`:** protocolo del servidor de correo, admite los valores `smtp` y `smpts`.  
>   **Por defecto:** `smtp`
>
...
docker run --detach \
  ...
  repo.stratebi.com/lincebi/biserver:9.3.0.6-764-1
```
