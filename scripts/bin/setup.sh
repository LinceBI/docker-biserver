...
# shellcheck disable=SC2034
{
	...
	SAML_LOGOUT_URL=$(getVar SAML_LOGOUT_URL "${FQSU_PROTOCOL:?}://${FQSU_DOMAIN:?}:${FQSU_PORT:?}")
	SAML_SP_METADATA_ENTITYID=$(getVar SAML_SP_METADATA_ENTITYID "biserver")
	SAML_SP_METADATA_URL=$(getVar SAML_SP_METADATA_URL "")
	SAML_SP_METADATA_FILESYSTEM=$(getVar SAML_SP_METADATA_FILESYSTEM "")
	SAML_SP_METADATA_CLASSPATH=$(getVar SAML_SP_METADATA_CLASSPATH "")
	SAML_IDP_URL=$(getVar SAML_IDP_URL "")
	SAML_IDP_METADATA_URL=$(getVar SAML_IDP_METADATA_URL "")
	SAML_IDP_METADATA_FILESYSTEM=$(getVar SAML_IDP_METADATA_FILESYSTEM "")
	SAML_IDP_METADATA_CLASSPATH=$(getVar SAML_IDP_METADATA_CLASSPATH "")
	SAML_VALID_RESPONSE_INTERVAL_IN_SECS=$(getVar SAML_VALID_RESPONSE_INTERVAL_IN_SECS "86400")
	SAML_MAX_AUTHENTICATION_AGE_IN_SECS=$(getVar SAML_MAX_AUTHENTICATION_AGE_IN_SECS "7200")
	SAML_ROLE_RELATED_USER_ATTRIBUTE_NAME=$(getVar SAML_ROLE_RELATED_USER_ATTRIBUTE_NAME "Role")
	SAML_ROLE_RELATED_USER_ATTRIBUTE_PREFIX=$(getVar SAML_ROLE_RELATED_USER_ATTRIBUTE_PREFIX "Pentaho:")
	SAML_KEYSTORE_URL=$(getVar SAML_KEYSTORE_URL "")
	SAML_KEYSTORE_FILESYSTEM=$(getVar SAML_KEYSTORE_FILESYSTEM "")
	SAML_KEYSTORE_CLASSPATH=$(getVar SAML_KEYSTORE_CLASSPATH "")
	SAML_KEYSTORE_PASSWORD=$(getVar SAML_KEYSTORE_PASSWORD "changeit")
	SAML_KEYSTORE_PRIVATE_USERNAME_PASSWORDS=$(getVar SAML_KEYSTORE_PRIVATE_USERNAME_PASSWORDS "saml:changeit")
	SAML_USERNAME_PASSWORD_DELIMITER_CHAR=$(getVar SAML_USERNAME_PASSWORD_DELIMITER_CHAR ":")
	SAML_KEYSTORE_DEFAULT_KEY=$(getVar SAML_KEYSTORE_DEFAULT_KEY "saml")
	SAML_CANONICALIZATION_ALGORITHM=$(getVar SAML_CANONICALIZATION_ALGORITHM "C14N-EXCL-OMIT-COMMENTS")
	SAML_SIGNATURE_ALGORITHM=$(getVar SAML_SIGNATURE_ALGORITHM "RSA-SHA256")
	SAML_DATAENCRYPTION_ALGORITHM=$(getVar SAML_DATAENCRYPTION_ALGORITHM "AES256")
	SAML_KEYTRANSPORTENCRYPTION_ALGORITHM=$(getVar SAML_KEYTRANSPORTENCRYPTION_ALGORITHM "RSA-OAEP")
	SAML_ENSURE_INCOMING_LOGOUT_REQUEST_SIGNED=$(getVar SAML_ENSURE_INCOMING_LOGOUT_REQUEST_SIGNED "true")
	SAML_ENSURE_OUTGOING_LOGOUT_RESPONSE_SIGNED=$(getVar SAML_ENSURE_OUTGOING_LOGOUT_RESPONSE_SIGNED "true")
	SAML_ENSURE_OUTGOING_LOGOUT_REQUEST_SIGNED=$(getVar SAML_ENSURE_OUTGOING_LOGOUT_REQUEST_SIGNED "true")
	SAML_USE_GLOBAL_LOGOUT_STRATEGY=$(getVar SAML_USE_GLOBAL_LOGOUT_STRATEGY "true")
	SAML_AUTHORIZATION_PROVIDER=$(getVar SAML_AUTHORIZATION_PROVIDER "saml")
	SAML_CREATE_USER_DETAILS_NOT_FOUND_IN_AUTHORIZATION_PROVIDER=$(getVar SAML_CREATE_USER_DETAILS_NOT_FOUND_IN_AUTHORIZATION_PROVIDER "false")
	SAML_LB_ENABLED=$(getVar SAML_LB_ENABLED "false")
	SAML_LB_SCHEME=$(getVar SAML_LB_SCHEME "http")
	SAML_LB_SERVER_NAME=$(getVar SAML_LB_SERVER_NAME "localhost")
	SAML_LB_CONTEXT_PATH=$(getVar SAML_LB_CONTEXT_PATH "/pentaho")
	SAML_LB_SERVER_PORT=$(getVar SAML_LB_SERVER_PORT "8080")
	SAML_LB_INCLUDE_PORT_IN_REQUEST_URL=$(getVar SAML_LB_INCLUDE_PORT_IN_REQUEST_URL "true")
	...
	CACHE_USER_TIME_TO_IDLE=$(getVar CACHE_USER_TIME_TO_IDLE "300")
	CACHE_USER_TIME_TO_LIVE=$(getVar CACHE_USER_TIME_TO_LIVE "600")
	CACHE_USER_ROLE_LIST_TIME_TO_IDLE=$(getVar CACHE_USER_ROLE_LIST_TIME_TO_IDLE "300")
	CACHE_USER_ROLE_LIST_TIME_TO_LIVE=$(getVar CACHE_USER_ROLE_LIST_TIME_TO_LIVE "600")
	CACHE_LDAP_POPULATOR_TIME_TO_IDLE=$(getVar CACHE_LDAP_POPULATOR_TIME_TO_IDLE "300")
	CACHE_LDAP_POPULATOR_TIME_TO_LIVE=$(getVar CACHE_LDAP_POPULATOR_TIME_TO_LIVE "600")
	CACHE_LDAP_AUTHENTICATOR_TIME_TO_IDLE=$(getVar CACHE_LDAP_AUTHENTICATOR_TIME_TO_IDLE "300")
	CACHE_LDAP_AUTHENTICATOR_TIME_TO_LIVE=$(getVar CACHE_LDAP_AUTHENTICATOR_TIME_TO_LIVE "600")
	CACHE_PRINCIPAL_PROVIDER_ROLE_TIME_TO_IDLE=$(getVar CACHE_PRINCIPAL_PROVIDER_ROLE_TIME_TO_IDLE "300")
	CACHE_PRINCIPAL_PROVIDER_ROLE_TIME_TO_LIVE=$(getVar CACHE_PRINCIPAL_PROVIDER_ROLE_TIME_TO_LIVE "600")
	CACHE_PRINCIPAL_PROVIDER_USER_TIME_TO_IDLE=$(getVar CACHE_PRINCIPAL_PROVIDER_USER_TIME_TO_IDLE "300")
	CACHE_PRINCIPAL_PROVIDER_USER_TIME_TO_LIVE=$(getVar CACHE_PRINCIPAL_PROVIDER_USER_TIME_TO_LIVE "600")
