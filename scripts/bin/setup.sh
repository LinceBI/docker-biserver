...
# shellcheck disable=SC2034
{
	...
	POSTGRES_USER=$(getVar POSTGRES_USER "${POSTGRES_MAINTENANCE_USER-postgres}")
	POSTGRES_PASSWORD=$(getVar POSTGRES_PASSWORD "${POSTGRES_MAINTENANCE_PASSWORD-postgres}")
	POSTGRES_DATABASE=$(getVar POSTGRES_DATABASE "${POSTGRES_MAINTENANCE_DATABASE-postgres}")
	...
	COCKROACH_USER=$(getVar COCKROACH_USER "${COCKROACH_MAINTENANCE_USER-root}")
	COCKROACH_PASSWORD=$(getVar COCKROACH_PASSWORD "${COCKROACH_MAINTENANCE_PASSWORD-root}")
	COCKROACH_DATABASE=$(getVar COCKROACH_DATABASE "${COCKROACH_MAINTENANCE_DATABASE-postgres}")
	...
	MYSQL_USER=$(getVar MYSQL_USER "${MYSQL_MAINTENANCE_USER-root}")
	MYSQL_PASSWORD=$(getVar MYSQL_PASSWORD "${MYSQL_MAINTENANCE_PASSWORD-root}")
	MYSQL_DATABASE=$(getVar MYSQL_DATABASE "${MYSQL_MAINTENANCE_DATABASE-mysql}")
