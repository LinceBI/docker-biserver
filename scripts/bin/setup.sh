...
# shellcheck disable=SC2034
{
	...
	MAIL_SMTP_AUTH_MECHANISMS=$(getVar MAIL_SMTP_AUTH_MECHANISMS "basic")
	MAIL_SMTP_USER=$(getVar MAIL_SMTP_USER "user@example.localhost")
	MAIL_SMTP_PASSWORD=$(getVar MAIL_SMTP_PASSWORD "password")
	MAIL_SMTP_XOAUTH2_CLIENT_ID=$(getVar MAIL_SMTP_XOAUTH2_CLIENT_ID "")
	MAIL_SMTP_XOAUTH2_CLIENT_SECRET=$(getVar MAIL_SMTP_XOAUTH2_CLIENT_SECRET "")
	MAIL_SMTP_XOAUTH2_SCOPE=$(getVar MAIL_SMTP_XOAUTH2_SCOPE "")
	MAIL_SMTP_XOAUTH2_TOKEN_URL=$(getVar MAIL_SMTP_XOAUTH2_TOKEN_URL "")
	MAIL_SMTP_XOAUTH2_GRANT_TYPE=$(getVar MAIL_SMTP_XOAUTH2_GRANT_TYPE "")
	MAIL_SMTP_XOAUTH2_AUTHORIZATION_CODE=$(getVar MAIL_SMTP_XOAUTH2_AUTHORIZATION_CODE "")
	MAIL_SMTP_XOAUTH2_REDIRECT_URI=$(getVar MAIL_SMTP_XOAUTH2_REDIRECT_URI "")
	MAIL_SMTP_XOAUTH2_REFRESH_TOKEN=$(getVar MAIL_SMTP_XOAUTH2_REFRESH_TOKEN "")
	...
	PENTAHO_AUDIT_ENTRY=$(getVar PENTAHO_AUDIT_ENTRY "database")
	PENTAHO_AUDIT_STORAGE_TYPE=$(getVar PENTAHO_AUDIT_STORAGE_TYPE "postgres")
	if [ "${PENTAHO_AUDIT_STORAGE_TYPE:?}" = 'postgres' ]; then
		PENTAHO_AUDIT_DATABASE_DRIVER=$(getVar PENTAHO_AUDIT_DATABASE_DRIVER "org.postgresql.Driver")
		PENTAHO_AUDIT_DATABASE_HOST=$(getVar POSTGRES_HOST "postgres")
		PENTAHO_AUDIT_DATABASE_PORT=$(getVar POSTGRES_PORT "5432")
		PENTAHO_AUDIT_DATABASE_NAME=$(getVar PENTAHO_AUDIT_DATABASE_NAME "stmonitoring_database")
		PENTAHO_AUDIT_DATABASE_SCHEMA=$(getVar PENTAHO_AUDIT_DATABASE_SCHEMA "stmonitoring_schema")
		PENTAHO_AUDIT_DATABASE_USER=$(getVar PENTAHO_AUDIT_DATABASE_USER "stmonitoring_admin")
		PENTAHO_AUDIT_DATABASE_PASSWORD=$(getVar PENTAHO_AUDIT_DATABASE_PASSWORD "password")
		PENTAHO_AUDIT_DATABASE_URL=$(getVar PENTAHO_AUDIT_DATABASE_URL "jdbc:postgresql://${PENTAHO_AUDIT_DATABASE_HOST:?}:${PENTAHO_AUDIT_DATABASE_PORT:?}/${PENTAHO_AUDIT_DATABASE_NAME:?}")
	elif [ "${PENTAHO_AUDIT_STORAGE_TYPE:?}" = 'hsqldb' ]; then
		PENTAHO_AUDIT_DATABASE_DRIVER=$(getVar PENTAHO_AUDIT_DATABASE_DRIVER "org.hsqldb.jdbcDriver")
		PENTAHO_AUDIT_DATABASE_HOST=$(getVar HSQLDB_HOST "localhost")
		PENTAHO_AUDIT_DATABASE_PORT=$(getVar HSQLDB_PORT "9001")
		PENTAHO_AUDIT_DATABASE_NAME=$(getVar PENTAHO_AUDIT_DATABASE_NAME "stmonitoring")
		PENTAHO_AUDIT_DATABASE_SCHEMA=$(getVar PENTAHO_AUDIT_DATABASE_SCHEMA "stmonitoring")
		PENTAHO_AUDIT_DATABASE_USER=$(getVar PENTAHO_AUDIT_DATABASE_USER "stmonitoring_admin")
		PENTAHO_AUDIT_DATABASE_PASSWORD=$(getVar PENTAHO_AUDIT_DATABASE_PASSWORD "password")
		PENTAHO_AUDIT_DATABASE_URL=$(getVar PENTAHO_AUDIT_DATABASE_URL "jdbc:hsqldb:hsql://${PENTAHO_AUDIT_DATABASE_HOST:?}:${PENTAHO_AUDIT_DATABASE_PORT:?}/${PENTAHO_AUDIT_DATABASE_NAME:?}")
	fi
	set +a
}
