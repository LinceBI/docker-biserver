...
[ -z "${POSTGRES_JACKRABBIT_JDBC_PARAMS-}" ] && export POSTGRES_JACKRABBIT_JDBC_PARAMS=''
[ -z "${POSTGRES_JACKRABBIT_JDBC_URL-}"    ] && export POSTGRES_JACKRABBIT_JDBC_URL="jdbc:postgresql://${POSTGRES_HOST:?}:${POSTGRES_PORT:?}/${POSTGRES_JACKRABBIT_DATABASE:?}?${POSTGRES_JACKRABBIT_JDBC_PARAMS?}"
...
[ -z "${POSTGRES_HIBERNATE_JDBC_PARAMS-}"  ] && export POSTGRES_HIBERNATE_JDBC_PARAMS=''
[ -z "${POSTGRES_HIBERNATE_JDBC_URL-}"     ] && export POSTGRES_HIBERNATE_JDBC_URL="jdbc:postgresql://${POSTGRES_HOST:?}:${POSTGRES_PORT:?}/${POSTGRES_HIBERNATE_DATABASE:?}?${POSTGRES_HIBERNATE_JDBC_PARAMS?}"
...
[ -z "${POSTGRES_QUARTZ_JDBC_PARAMS-}"     ] && export POSTGRES_QUARTZ_JDBC_PARAMS=''
[ -z "${POSTGRES_QUARTZ_JDBC_URL-}"        ] && export POSTGRES_QUARTZ_JDBC_URL="jdbc:postgresql://${POSTGRES_HOST:?}:${POSTGRES_PORT:?}/${POSTGRES_QUARTZ_DATABASE:?}?${POSTGRES_QUARTZ_JDBC_PARAMS?}"
...
[ -z "${COCKROACH_JACKRABBIT_JDBC_PARAMS-}" ] && export COCKROACH_JACKRABBIT_JDBC_PARAMS=''
[ -z "${COCKROACH_JACKRABBIT_JDBC_URL-}"    ] && export COCKROACH_JACKRABBIT_JDBC_URL="jdbc:postgresql://${COCKROACH_HOST:?}:${COCKROACH_PORT:?}/${COCKROACH_JACKRABBIT_DATABASE:?}?${COCKROACH_JACKRABBIT_JDBC_PARAMS?}"
...
[ -z "${COCKROACH_HIBERNATE_JDBC_PARAMS-}"  ] && export COCKROACH_HIBERNATE_JDBC_PARAMS=''
[ -z "${COCKROACH_HIBERNATE_JDBC_URL-}"     ] && export COCKROACH_HIBERNATE_JDBC_URL="jdbc:postgresql://${COCKROACH_HOST:?}:${COCKROACH_PORT:?}/${COCKROACH_HIBERNATE_DATABASE:?}?${COCKROACH_HIBERNATE_JDBC_PARAMS?}"
...
[ -z "${COCKROACH_QUARTZ_JDBC_PARAMS-}"     ] && export COCKROACH_QUARTZ_JDBC_PARAMS=''
[ -z "${COCKROACH_QUARTZ_JDBC_URL-}"        ] && export COCKROACH_QUARTZ_JDBC_URL="jdbc:postgresql://${COCKROACH_HOST:?}:${COCKROACH_PORT:?}/${COCKROACH_QUARTZ_DATABASE:?}?${COCKROACH_QUARTZ_JDBC_PARAMS?}"
...
[ -z "${MYSQL_JACKRABBIT_JDBC_PARAMS-}" ] && export MYSQL_JACKRABBIT_JDBC_PARAMS=''
[ -z "${MYSQL_JACKRABBIT_JDBC_URL-}"    ] && export MYSQL_JACKRABBIT_JDBC_URL="jdbc:mysql://${MYSQL_HOST:?}:${MYSQL_PORT:?}/${MYSQL_JACKRABBIT_DATABASE:?}?${MYSQL_JACKRABBIT_JDBC_PARAMS?}"
...
[ -z "${MYSQL_HIBERNATE_JDBC_PARAMS-}"  ] && export MYSQL_HIBERNATE_JDBC_PARAMS=''
[ -z "${MYSQL_HIBERNATE_JDBC_URL-}"     ] && export MYSQL_HIBERNATE_JDBC_URL="jdbc:mysql://${MYSQL_HOST:?}:${MYSQL_PORT:?}/${MYSQL_HIBERNATE_DATABASE:?}?${MYSQL_HIBERNATE_JDBC_PARAMS?}"
...
[ -z "${MYSQL_QUARTZ_JDBC_PARAMS-}"     ] && export MYSQL_QUARTZ_JDBC_PARAMS=''
[ -z "${MYSQL_QUARTZ_JDBC_URL-}"        ] && export MYSQL_QUARTZ_JDBC_URL="jdbc:mysql://${MYSQL_HOST:?}:${MYSQL_PORT:?}/${MYSQL_QUARTZ_DATABASE:?}?${MYSQL_QUARTZ_JDBC_PARAMS?}"
